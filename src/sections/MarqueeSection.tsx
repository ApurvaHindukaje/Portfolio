...
export const MarqueeSection: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="flex w-max" style={{ willChange: 'transform' }} ref={row1Ref}>
        {ROW1_IMAGES.map((src, i) => (
          <div key={`row1-${i}`} className="mr-3 h-[270px] w-[420px] shrink-0">
            <img
              src={src}
              alt="Marquee Item"
              loading="lazy"
      ...
      <div className="flex w-max" style={{ willChange: 'transform' }} ref={row2Ref}>
        {ROW2_IMAGES.map((src, i) => (
          <div key={`row2-${i}`} className="mr-3 h-[270px] w-[420px] shrink-0">
            <img
              src={src}
              alt="Marquee Item"
              loading="lazy"
